...
# The database file for training data. Created by data/VOC0712/create_data.sh
train_data = "/home/ywlee/data/VOCdevkit/VOC0712/lmdb/VOC0712_trainval_lmdb"
# The database file for testing data. Created by data/VOC0712/create_data.sh
test_data = "/home/ywlee/data/VOCdevkit/VOC0712/lmdb/VOC0712_test_lmdb"
...
job_name = "RefineDet_VoVNet39_{}".format(resize)
# The name of the model. Modify it if you want.
model_name = "VOC0712_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VoVNet/VOC0712/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/VoVNet/VOC0712/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VoVNet/VOC0712/{}".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/VoVNet/VOC0712/results/{}".format(os.environ['HOME'], job_name)
...
pretrain_model = "models/ImageNet/VoVNet/VoVNet39_ImageNet_Pretrained.caffemodel"
# Stores LabelMapItem.
...
arm_source_layers = ['Transition3/relu', 'Transition4B/relu', 'Transition5B/relu', 'res6_relu']
...
VoVNet39_Body(net, from_layer='data',global_pool=False)
...
multibox_loss_param_arm['overlap_threshold'] = 0.7 #ywlee
multibox_loss_param_arm['neg_overlap'] = 0.3 #ywlee
